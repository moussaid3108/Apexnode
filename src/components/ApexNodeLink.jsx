...
main{position:relative;z-index:1;width:100%;max-width:820px;margin:0 auto;padding:16px 16px;display:flex;flex-direction:column;justify-content:center;gap:18px;flex:1}
